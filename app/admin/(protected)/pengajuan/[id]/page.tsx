  ...
  if (!caseItem) {
    return (
      <div className="rounded-2xl border border-gray-200 bg-white p-10 text-center">
        <h1 className="text-2xl font-bold tracking-tight text-gray-900">Pengajuan tidak ditemukan</h1>
        <p className="mt-3 text-gray-600">Case ini mungkin sudah dipindahkan atau belum tersinkron ke state lokal.</p>

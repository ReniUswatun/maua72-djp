...
const LANGKAH = [
  {
    icon: ClipboardCheck,
    judul: "UMKM mengisi asesmen",
    teks: "Delapan pilar kesiapan ekspor diisi dalam bahasa awam, sekitar 10 menit.",
  },
  {
    icon: Sparkles,
    judul: "Sistem menyusun draf",
    teks: "Skor per dimensi, alasan di balik skor, dan draf rekomendasi — semua ditandai sebagai draf, belum final.",
  },
  {
    icon: ShieldCheck,
    judul: "Officer meninjau",
    teks: "Petugas Bea Cukai memperbaiki draf bila perlu, lalu mengambil keputusan: setujui, tolak, atau minta info.",
  },
  {
    icon: FileCheck2,
    judul: "UMKM menerima hasil final",
    teks: "Rekomendasi yang sudah divalidasi dikirim ke UMKM, lengkap dengan catatan petugas.",
  },
];
...
const PERAN = [
  ...
  },
  {
    ...
    icon: ShieldCheck,
    nama: "Officer",
    ringkas: "Petugas Bea Cukai yang mendampingi UMKM.",
    bisa: [
      "Monitoring semua pengajuan UMKM masuk",
      "Tinjau draf AI: skor, alasan, dan tingkat keyakinan",
      "Sunting rekomendasi & ambil keputusan final",
      "Susun draf pesan WhatsApp ke UMKM",
    ],
    primary: { label: "Masuk sebagai Officer", href: "/masuk?peran=officer" },
    secondary: null,
  ...
  },
  {
    ...
    icon: UserCog,
    nama: "Super Admin",
    ringkas: "Pengelola sistem dan tata kelola akses.",
    bisa: [
      "CRUD akun officer & reset akses",
      "Atur hak akses per peran (RBAC)",
      "Pantau log aktivitas admin",
      "Lihat metrik akurasi draf AI dari waktu ke waktu",
    ],
    primary: { label: "Masuk sebagai Super Admin", href: "/masuk?peran=super_admin" },
    secondary: null,

...
const LANGKAH = [
  ...
  },
  {
    ...
    teks: "Petugas Bea Cukai memeriksa data usaha dan dokumen beserta catatan OCR, lalu mengambil keputusan: setujui, tolak, atau minta info.",
  },
  {
    icon: FileCheck2,
...
const PERAN = [
  ...
  },
  {
    ...
    bisa: [
      ...
      "Ambil keputusan final & susun draf pesan WhatsApp ke UMKM",
    ],
    primary: { label: "Masuk sebagai Officer", href: "/masuk" },
    secondary: null,
  ...
  },
  {
    ...
    bisa: [
      "CRUD akun officer & super admin, reset akses",
      "Atur hak akses per peran (RBAC)",
      "Pantau log aktivitas admin",
      "Lihat metrik akurasi OCR dokumen dari waktu ke waktu",
    ],
